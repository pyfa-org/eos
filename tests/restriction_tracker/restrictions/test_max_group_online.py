...
class TestMaxGroupOnline(RestrictionTestCase):
    ...
    def test_mix_excess_one(self):
        ...
        holder1 = Mock(state=State.online, item=item1, _location=Location.ship, spec_set=ModuleHigh)
        self.track_holder(holder1)
        item2 = self.ch.type_(type_id=2, group_id=92, attributes={Attribute.max_group_online: 2})
        holder2 = Mock(state=State.online, item=item2, _location=Location.ship, spec_set=ModuleHigh)
        self.track_holder(holder2)
        restriction_error1 = self.get_restriction_error(holder1, Restriction.max_group_online)
        self.assertIsNotNone(restriction_error1)
        self.assertEqual(restriction_error1.max_group, 1)
    ...
    def test_mix_excess_original(self):
        ...
        item1 = self.ch.type_(type_id=1, group_id=61, attributes={Attribute.max_group_online: 1})
        holder1 = Mock(state=State.online, item=item1, _location=Location.ship, spec_set=ModuleHigh)
    ...
    def test_pass(self):
        ...
        item = self.ch.type_(type_id=1, group_id=860, attributes={Attribute.max_group_online: 2})
        holder1 = Mock(state=State.online, item=item, _location=Location.ship, spec_set=ModuleHigh)
        self.track_holder(holder1)
        holder2 = Mock(state=State.online, item=item, _location=Location.ship, spec_set=ModuleHigh)
        self.track_holder(holder2)
    ...
    def test_pass_holder_none_group(self):
        ...
        item = self.ch.type_(type_id=1, group_id=None, attributes={Attribute.max_group_online: 1})
        holder1 = Mock(state=State.online, item=item, _location=Location.ship, spec_set=ModuleHigh)
        self.track_holder(holder1)
        holder2 = Mock(state=State.online, item=item, _location=Location.ship, spec_set=ModuleHigh)
        self.track_holder(holder2)
    ...
    def test_pass_state(self):
        ...
        item = self.ch.type_(type_id=1, group_id=886, attributes={Attribute.max_group_online: 1})
    ...
    def test_pass_holder_non_ship(self):
        ...
        item = self.ch.type_(type_id=1, group_id=12, attributes={Attribute.max_group_online: 1})
        holder1 = Mock(state=State.online, item=item, _location=None, spec_set=ModuleHigh)
        self.track_holder(holder1)
        holder2 = Mock(state=State.online, item=item, _location=None, spec_set=ModuleHigh)
        self.track_holder(holder2)
        restriction_error1 = self.get_restriction_error(holder1, Restriction.max_group_online)
        self.assertIsNone(restriction_error1)
        restriction_error2 = self.get_restriction_error(holder2, Restriction.max_group_online)

...
class TestOperatorPostPercent(CalculatorTestCase):
    ...
    def setUp(self):
        ...
        self.influence_source1 = Implant(self.ch.type(attributes={src_attr.id: 20}, effects=[effect]).id)
        self.influence_source2 = Implant(self.ch.type(attributes={src_attr.id: 50}, effects=[effect]).id)
        self.influence_source3 = Implant(self.ch.type(attributes={src_attr.id: -90}, effects=[effect]).id)
        self.influence_source4 = Implant(self.ch.type(attributes={src_attr.id: -25}, effects=[effect]).id)
        self.influence_source5 = Implant(self.ch.type(attributes={src_attr.id: 400}, effects=[effect]).id)

...
class TestTransitionFit(CalculatorTestCase):
    ...
    def test_source_attr_update(self):
        ...
        tgt_attr1 = cache_handler1.attribute(max_attribute=33)
        cache_handler1.attribute(default_value=100)
        src_attr2 = cache_handler2.attribute(attribute_id=1)
        tgt_attr2 = cache_handler2.attribute(max_attribute=333)
        cache_handler2.attribute(default_value=500)
        modifier = DogmaModifier(
            tgt_filter=ModifierTargetFilter.domain,
            tgt_domain=ModifierDomain.ship,
            tgt_attr=2,
        ...
        ship_eve_type2 = cache_handler2.type(effects=(effect2,), attributes={src_attr2.id: 20})
        module_eve_type1 = cache_handler1.type(attributes={tgt_attr1.id: 50})
        module_eve_type2 = cache_handler2.type(attributes={tgt_attr2.id: 75})

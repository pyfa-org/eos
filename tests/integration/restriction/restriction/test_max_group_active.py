...
class TestMaxGroupActive(RestrictionTestCase):
    ...
    def test_fail_excess_all(self):
        ...
        eve_type = self.ch.type(
            group=6, attributes={AttributeId.max_group_active: 1})
    ...
    def test_pass(self):
        ...
        eve_type = self.ch.type(
            group=860, attributes={AttributeId.max_group_active: 2})
        item1 = ModuleHigh(eve_type.id, state=State.active)
        self.fit.modules.high.append(item1)
        item2 = ModuleHigh(eve_type.id, state=State.active)
        self.fit.modules.high.append(item2)
    ...
    def test_pass_item_none_group(self):
        ...
        eve_type = self.ch.type(
            group=None, attributes={AttributeId.max_group_active: 1})
        item1 = ModuleHigh(eve_type.id, state=State.active)
        self.fit.modules.high.append(item1)
        item2 = ModuleHigh(eve_type.id, state=State.active)
        self.fit.modules.high.append(item2)
    ...
    def test_pass_state(self):
        ...
        eve_type = self.ch.type(
            group=886, attributes={AttributeId.max_group_active: 1})
    ...
    def test_pass_item_other_class(self):
        eve_type = self.ch.type(
            group=12, attributes={AttributeId.max_group_active: 1})

...
class TestLowSlot(RestrictionTestCase):
    ...
    def setUp(self):
        super().setUp()
        self.ch.attr(attribute_id=Attribute.low_slots)
    ...
    def test_fail_excess_single(self):
        ...
        self.fit.ship = Ship(self.ch.type(
            attributes={Attribute.low_slots: 0}).id)
    ...
    def test_fail_excess_multiple(self):
        ...
        self.fit.ship = Ship(self.ch.type(
            attributes={Attribute.low_slots: 1}).id)
    ...
    def test_fail_excess_multiple_with_nones(self):
        ...
        self.fit.ship = Ship(self.ch.type(
            attributes={Attribute.low_slots: 3}).id)
        eve_type = self.ch.type(effects=[self.effect])
        item1 = ModuleLow(eve_type.id)
        item2 = ModuleLow(eve_type.id)
    ...
    def test_pass_equal(self):
        self.fit.ship = Ship(self.ch.type(
            attributes={Attribute.low_slots: 2}).id)
        eve_type = self.ch.type(effects=[self.effect])
        item1 = ModuleLow(eve_type.id)
        item2 = ModuleLow(eve_type.id)
        self.fit.modules.low.append(item1)
    ...
    def test_pass_greater(self):
        self.fit.ship = Ship(self.ch.type(
            attributes={Attribute.low_slots: 5}).id)
        eve_type = self.ch.type(effects=[self.effect])
        item1 = ModuleLow(eve_type.id)
        item2 = ModuleLow(eve_type.id)
        self.fit.modules.low.append(item1)

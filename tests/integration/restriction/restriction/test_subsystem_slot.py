...
class TestSubsystemSlot(RestrictionTestCase):
    ...
    def test_fail_excess_signle(self):
        ...
        self.add_item(item)
        fit.stats.subsystem_slots.used = 1
        fit.stats.subsystem_slots.total = 0
    ...
    def test_fail_excess_signle_undefined_output(self):
        ...
        self.add_item(item)
        fit.stats.subsystem_slots.used = 1
        fit.stats.subsystem_slots.total = None
        restriction_error = self.get_restriction_error(fit, item, Restriction.subsystem_slot)
        self.assertIsNotNone(restriction_error)
        self.assertEqual(restriction_error.slots_max_allowed, 0)
        self.assertEqual(restriction_error.slots_used, 1)
    ...
    def test_fail_excess_multiple(self):
        ...
        self.add_item(item1)
        self.add_item(item2)
        fit.stats.subsystem_slots.used = 2
        fit.stats.subsystem_slots.total = 1
    ...
    def test_pass_equal(self):
        ...
        self.add_item(item2)
        fit.stats.subsystem_slots.used = 2
        fit.stats.subsystem_slots.total = 2
        restriction_error1 = self.get_restriction_error(fit, item1, Restriction.subsystem_slot)
    ...
    def test_pass_greater(self):
        ...
        self.add_item(item2)
        fit.stats.subsystem_slots.used = 2
        fit.stats.subsystem_slots.total = 5
        restriction_error1 = self.get_restriction_error(fit, item1, Restriction.subsystem_slot)
        self.assertIsNone(restriction_error1)
        restriction_error2 = self.get_restriction_error(fit, item2, Restriction.subsystem_slot)
        self.assertIsNone(restriction_error2)

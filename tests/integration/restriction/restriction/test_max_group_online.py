...
class TestMaxGroupOnline(RestrictionTestCase):
    ...
    def test_fail_excess_all(self):
        ...
        item_type = self.ch.type(
            group_id=6, attrs={AttrId.max_group_online: 1})
    ...
    def test_mix_excess_one(self):
        ...
        item1 = ModuleHigh(
            self.ch.type(
                group_id=92, attrs={AttrId.max_group_online: 1}).id,
            state=State.online)
        self.fit.modules.high.append(item1)
        item2 = ModuleHigh(
            self.ch.type(
                group_id=92, attrs={AttrId.max_group_online: 2}).id,
            state=State.online)
        self.fit.modules.high.append(item2)
        # Action
        restriction_error1 = self.get_restriction_error(
    ...
    def test_pass(self):
        ...
        item_type = self.ch.type(
            group_id=860, attrs={AttrId.max_group_online: 2})
        item1 = ModuleHigh(item_type.id, state=State.online)
        self.fit.modules.high.append(item1)
        item2 = ModuleHigh(item_type.id, state=State.online)
        self.fit.modules.high.append(item2)
    ...
    def test_pass_item_none_group(self):
        ...
        item_type = self.ch.type(
            group_id=None, attrs={AttrId.max_group_online: 1})
        item1 = ModuleHigh(item_type.id, state=State.online)
        self.fit.modules.high.append(item1)
        item2 = ModuleHigh(item_type.id, state=State.online)
        self.fit.modules.high.append(item2)
    ...
    def test_pass_state(self):
        ...
        item_type = self.ch.type(
            group_id=886, attrs={AttrId.max_group_online: 1})
    ...
    def test_pass_item_other_class(self):
        item_type = self.ch.type(
            group_id=12, attrs={AttrId.max_group_online: 1})

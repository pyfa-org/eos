...
class TestLowSlot(RestrictionTestCase):
    ...
    def test_fail_excess_signle(self):
        ...
        restriction_error = self.get_restriction_error(item, Restriction.low_slot)
    ...
    def test_fail_excess_multiple(self):
        ...
        restriction_error1 = self.get_restriction_error(item1, Restriction.low_slot)
        self.assertIsNone(restriction_error1)
        restriction_error2 = self.get_restriction_error(item2, Restriction.low_slot)
    ...
    def test_fail_excess_multiple_with_nones(self):
        ...
        self.fit.modules.low.append(item2)
        self.fit.modules.low.append(None)
        self.fit.modules.low.append(item3)
        ...
        restriction_error3 = self.get_restriction_error(item2, Restriction.low_slot)

...
class TestMaxGroupOnline(RestrictionTestCase):
    ...
    def test_fail_excess_all(self):
        ...
        eve_type = self.ch.type(type_id=1, group=6, attributes={Attribute.max_group_online: 1})
        ...
        self.add_item(item2)
        # Action
        restriction_error1 = self.get_restriction_error(item1, Restriction.max_group_online)
        # Verification
        ...
        # Action
        restriction_error2 = self.get_restriction_error(item2, Restriction.max_group_online)
        # Verification
    ...
    def test_mix_excess_one(self):
        ...
        eve_type1 = self.ch.type(type_id=1, group=92, attributes={Attribute.max_group_online: 1})
        item1 = self.make_item_mock(ModuleHigh, eve_type1, state=State.online)
        self.add_item(item1)
        eve_type2 = self.ch.type(type_id=2, group=92, attributes={Attribute.max_group_online: 2})
        item2 = self.make_item_mock(ModuleHigh, eve_type2, state=State.online)
        self.add_item(item2)
        # Action
        restriction_error1 = self.get_restriction_error(item1, Restriction.max_group_online)
        # Verification
    ...
    def test_mix_excess_attr_eve_type(self):
        ...
        eve_type1 = self.ch.type(type_id=1, group=61, attributes={Attribute.max_group_online: 1})
        item1 = self.make_item_mock(ModuleHigh, eve_type1, state=State.online)
        item1.attributes = {Attribute.max_group_online: 2}
        self.add_item(item1)
        eve_type2 = self.ch.type(type_id=2, group=61, attributes={Attribute.max_group_online: 2})
        item2 = self.make_item_mock(ModuleHigh, eve_type2, state=State.online)
    ...
    def test_pass(self):
        ...
        eve_type = self.ch.type(type_id=1, group=860, attributes={Attribute.max_group_online: 2})
        item1 = self.make_item_mock(ModuleHigh, eve_type, state=State.online)
        self.add_item(item1)
        item2 = self.make_item_mock(ModuleHigh, eve_type, state=State.online)
        self.add_item(item2)
    ...
    def test_pass_item_none_group(self):
        ...
        eve_type = self.ch.type(type_id=1, group=None, attributes={Attribute.max_group_online: 1})
        item1 = self.make_item_mock(ModuleHigh, eve_type, state=State.online)
        self.add_item(item1)
        item2 = self.make_item_mock(ModuleHigh, eve_type, state=State.online)
        self.add_item(item2)
    ...
    def test_pass_state(self):
        ...
        eve_type = self.ch.type(type_id=1, group=886, attributes={Attribute.max_group_online: 1})
    ...
    def test_pass_item_non_module(self):
        ...
        self.add_item(item1)
        item2 = self.make_item_mock(Rig, eve_type, state=State.online)
        self.add_item(item2)
        # Action
        restriction_error1 = self.get_restriction_error(item1, Restriction.max_group_online)
        # Verification

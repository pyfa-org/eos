...
class TestMaxGroupOnline(RestrictionTestCase):
    ...
    def test_fail_excess_all(self):
        ...
        eve_type = self.ch.type_(type_id=1, group=6, attributes={Attribute.max_group_online: 1})
    ...
    def test_mix_excess_one(self):
        ...
        eve_type1 = self.ch.type_(type_id=1, group=92, attributes={Attribute.max_group_online: 1})
        holder1 = Mock(state=State.online, _eve_type=eve_type1, _domain=ModifierDomain.ship, spec_set=ModuleHigh(1))
        self.add_holder(holder1)
        eve_type2 = self.ch.type_(type_id=2, group=92, attributes={Attribute.max_group_online: 2})
        holder2 = Mock(state=State.online, _eve_type=eve_type2, _domain=ModifierDomain.ship, spec_set=ModuleHigh(1))
        self.add_holder(holder2)
        restriction_error1 = self.get_restriction_error(holder1, Restriction.max_group_online)
        self.assertIsNotNone(restriction_error1)
        self.assertEqual(restriction_error1.max_group, 1)
    ...
    def test_mix_excess_attr_eve_type(self):
        ...
        eve_type1 = self.ch.type_(type_id=1, group=61, attributes={Attribute.max_group_online: 1})
        holder1 = Mock(state=State.online, _eve_type=eve_type1, _domain=ModifierDomain.ship, spec_set=ModuleHigh(1))
        holder1.attributes = {Attribute.max_group_online: 2}
        self.add_holder(holder1)
        eve_type2 = self.ch.type_(type_id=2, group=61, attributes={Attribute.max_group_online: 2})
        holder2 = Mock(state=State.online, _eve_type=eve_type2, _domain=ModifierDomain.ship, spec_set=ModuleHigh(1))
    ...
    def test_pass(self):
        ...
        eve_type = self.ch.type_(type_id=1, group=860, attributes={Attribute.max_group_online: 2})
        holder1 = Mock(state=State.online, _eve_type=eve_type, _domain=ModifierDomain.ship, spec_set=ModuleHigh(1))
        self.add_holder(holder1)
        holder2 = Mock(state=State.online, _eve_type=eve_type, _domain=ModifierDomain.ship, spec_set=ModuleHigh(1))
        self.add_holder(holder2)
    ...
    def test_pass_holder_none_group(self):
        ...
        eve_type = self.ch.type_(type_id=1, group=None, attributes={Attribute.max_group_online: 1})
        holder1 = Mock(state=State.online, _eve_type=eve_type, _domain=ModifierDomain.ship, spec_set=ModuleHigh(1))
        self.add_holder(holder1)
        holder2 = Mock(state=State.online, _eve_type=eve_type, _domain=ModifierDomain.ship, spec_set=ModuleHigh(1))
        self.add_holder(holder2)
    ...
    def test_pass_state(self):
        ...
        eve_type = self.ch.type_(type_id=1, group=886, attributes={Attribute.max_group_online: 1})
    ...
    def test_pass_holder_non_ship(self):
        ...
        eve_type = self.ch.type_(type_id=1, group=12, attributes={Attribute.max_group_online: 1})
        holder1 = Mock(state=State.online, _eve_type=eve_type, _domain=None, spec_set=ModuleHigh(1))
        self.add_holder(holder1)
        holder2 = Mock(state=State.online, _eve_type=eve_type, _domain=None, spec_set=ModuleHigh(1))
        self.add_holder(holder2)
        restriction_error1 = self.get_restriction_error(holder1, Restriction.max_group_online)
        self.assertIsNone(restriction_error1)
        restriction_error2 = self.get_restriction_error(holder2, Restriction.max_group_online)

...
class TestTurretSlot(RestrictionTestCase):
    ...
    def test_fail_excess_signle(self):
        ...
        restriction_error = self.get_restriction_error(item, Restriction.turret_slot)
    ...
    def test_fail_excess_multiple(self):
        ...
        restriction_error1 = self.get_restriction_error(item1, Restriction.turret_slot)
        self.assertIsNotNone(restriction_error1)
        self.assertEqual(restriction_error1.slots_max_allowed, 1)
        self.assertEqual(restriction_error1.slots_used, 2)
        restriction_error2 = self.get_restriction_error(item2, Restriction.turret_slot)

...
class TestBuilderEtreeTgtDom(ModBuilderTestCase):
    ...
    def make_etree(self, domain):
        ...
        e_tgt_attr = self.ef.make(2, operandID=OperandId.def_attr, expressionAttributeID=1211)
        e_optr = self.ef.make(3, operandID=OperandId.def_optr, expressionValue='PostPercent')
        e_src_attr = self.ef.make(4, operandID=OperandId.def_attr, expressionAttributeID=1503)

...
class TestModGangItm(ModBuilderTestCase):
    ...
    def setUp(self):
        ...
        e_tgt_spec = self.ef.make(4, operandID=Operand.gen_attr, arg1=e_tgt_attr['expressionID'])
        e_optr_tgt = self.ef.make(5, operandID=Operand.optr_tgt, arg1=e_optr['expressionID'],
                                  arg2=e_tgt_spec['expressionID'])
        self.e_add_mod = self.ef.make(6, operandID=Operand.add_gang_itm_mod, arg1=e_optr_tgt['expressionID'],
                                      arg2=e_src_attr['expressionID'])
        self.e_rm_mod = self.ef.make(7, operandID=Operand.rm_gang_itm_mod, arg1=e_optr_tgt['expressionID'],
                                     arg2=e_src_attr['expressionID'])

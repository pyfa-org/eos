...
class TestModGangOwnSrq(ModBuilderTestCase):
    ...
    def setUp(self):
        ...
        self.e_add_mod = self.ef.make(7, operandID=Operand.add_gang_own_srq_mod, arg1=e_optr_tgt['expressionID'],
                                      arg2=e_src_attr['expressionID'])
        self.e_rm_mod = self.ef.make(8, operandID=Operand.rm_gang_own_srq_mod, arg1=e_optr_tgt['expressionID'],
                                     arg2=e_src_attr['expressionID'])

...
class TestModGangGrp(ModBuilderTestCase):
    ...
    def setUp(self):
        ...
        e_tgt_spec = self.ef.make(5, operandID=Operand.grp_attr, arg1=e_tgt_grp['expressionID'],
        ...
        self.e_add_mod = self.ef.make(7, operandID=Operand.add_gang_grp_mod, arg1=e_optr_tgt['expressionID'],
                                      arg2=e_src_attr['expressionID'])
        self.e_rm_mod = self.ef.make(8, operandID=Operand.rm_gang_grp_mod, arg1=e_optr_tgt['expressionID'],
                                     arg2=e_src_attr['expressionID'])

...
class TestModLocSrq(ModBuilderTestCase):
    ...
    def setUp(self):
        ...
        e_tgt_itms = self.ef.make(6, operandID=Operand.loc_srq, arg1=e_tgt_loc['expressionID'],
        ...
        self.e_add_mod = self.ef.make(9, operandID=Operand.add_loc_srq_mod, arg1=e_optr_tgt['expressionID'],
                                      arg2=e_src_attr['expressionID'])
        self.e_rm_mod = self.ef.make(10, operandID=Operand.rm_loc_srq_mod, arg1=e_optr_tgt['expressionID'],
                                     arg2=e_src_attr['expressionID'])

...
class TestModLoc(ModBuilderTestCase):
    ...
    def setUp(self):
        ...
        e_src_attr = self.ef.make(4, operandID=Operand.def_attr, expressionAttributeID=1503)
        ...
        self.e_add_mod = self.ef.make(7, operandID=Operand.add_loc_mod, arg1=e_optr_tgt['expressionID'],
                                      arg2=e_src_attr['expressionID'])
        self.e_rm_mod = self.ef.make(8, operandID=Operand.rm_loc_mod, arg1=e_optr_tgt['expressionID'],
                                     arg2=e_src_attr['expressionID'])

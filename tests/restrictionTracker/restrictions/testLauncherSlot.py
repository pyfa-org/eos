...
class TestLauncherSlot(RestrictionTestCase):
    ...
    def testFailExcessSignle(self):
        ...
        self.fit.stats.launcherSlots.used = 1
        self.fit.stats.launcherSlots.total = 0
        restrictionError = self.getRestrictionError(holder, Restriction.launcherSlot)
    ...
    def testFailExcessSignleUndefinedOutput(self):
        ...
        self.trackHolder(holder)
        self.fit.stats.launcherSlots.used = 1
        self.fit.stats.launcherSlots.total = None
        restrictionError = self.getRestrictionError(holder, Restriction.launcherSlot)
        self.assertIsNotNone(restrictionError)
        self.assertEqual(restrictionError.slotsMaxAllowed, 0)
        self.assertEqual(restrictionError.slotsUsed, 1)
    ...
    def testFailExcessMultiple(self):
        ...
        self.fit.stats.launcherSlots.used = 2
        self.fit.stats.launcherSlots.total = 1
        restrictionError1 = self.getRestrictionError(holder1, Restriction.launcherSlot)
        ...
        restrictionError2 = self.getRestrictionError(holder2, Restriction.launcherSlot)
    ...
    def testPassEqual(self):
        ...
        self.trackHolder(holder2)
        self.fit.stats.launcherSlots.used = 2
        self.fit.stats.launcherSlots.total = 2
        restrictionError1 = self.getRestrictionError(holder1, Restriction.launcherSlot)
    ...
    def testPassGreater(self):
        ...
        self.trackHolder(holder2)
        self.fit.stats.launcherSlots.used = 2
        self.fit.stats.launcherSlots.total = 5
        restrictionError1 = self.getRestrictionError(holder1, Restriction.launcherSlot)
        self.assertIsNone(restrictionError1)
        restrictionError2 = self.getRestrictionError(holder2, Restriction.launcherSlot)
        self.assertIsNone(restrictionError2)

...
class TestRigSlot(RestrictionTestCase):
    ...
    def testFailExcessSignle(self):
        ...
        self.fit.stats.rigSlots.used = 1
        self.fit.stats.rigSlots.total = 0
    ...
    def testFailExcessSignleUndefinedOutput(self):
        ...
        self.trackHolder(holder)
        self.fit.stats.rigSlots.used = 1
        self.fit.stats.rigSlots.total = None
        restrictionError = self.getRestrictionError(holder, Restriction.rigSlot)
        self.assertIsNotNone(restrictionError)
        self.assertEqual(restrictionError.slotsMaxAllowed, 0)
        self.assertEqual(restrictionError.slotsUsed, 1)
    ...
    def testFailExcessMultiple(self):
        ...
        self.fit.stats.rigSlots.used = 2
        self.fit.stats.rigSlots.total = 1
    ...
    def testPassEqual(self):
        ...
        self.trackHolder(holder2)
        self.fit.stats.rigSlots.used = 2
        self.fit.stats.rigSlots.total = 2
        restrictionError1 = self.getRestrictionError(holder1, Restriction.rigSlot)
    ...
    def testPassGreater(self):
        ...
        self.trackHolder(holder2)
        self.fit.stats.rigSlots.used = 2
        self.fit.stats.rigSlots.total = 5
        restrictionError1 = self.getRestrictionError(holder1, Restriction.rigSlot)
        self.assertIsNone(restrictionError1)
        restrictionError2 = self.getRestrictionError(holder2, Restriction.rigSlot)
        self.assertIsNone(restrictionError2)

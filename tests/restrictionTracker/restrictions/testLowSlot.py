...
class TestLowSlot(RestrictionTestCase):
    ...
    def testFailExcessSignle(self):
        ...
        self.fit.stats.lowSlots.used = 1
        self.fit.stats.lowSlots.total = 0
    ...
    def testFailExcessSignleUndefinedOutput(self):
        ...
        self.fit.modules.low.append(holder)
        self.fit.stats.lowSlots.used = 1
        self.fit.stats.lowSlots.total = None
        restrictionError = self.getRestrictionError(holder, Restriction.lowSlot)
        self.assertIsNotNone(restrictionError)
        self.assertEqual(restrictionError.slotsMaxAllowed, 0)
        self.assertEqual(restrictionError.slotsUsed, 1)
    ...
    def testFailExcessMultiple(self):
        ...
        self.fit.stats.lowSlots.used = 2
        self.fit.stats.lowSlots.total = 1
    ...
    def testFailExcessMultipleWithNones(self):
        ...
        self.fit.stats.lowSlots.used = 7
        self.fit.stats.lowSlots.total = 3
        restrictionError1 = self.getRestrictionError(holder1, Restriction.lowSlot)
        self.assertIsNone(restrictionError1)
        restrictionError2 = self.getRestrictionError(holder2, Restriction.lowSlot)
        self.assertIsNotNone(restrictionError2)
        ...
        restrictionError3 = self.getRestrictionError(holder2, Restriction.lowSlot)
    ...
    def testPassEqual(self):
        ...
        self.fit.modules.low.append(holder2)
        self.fit.stats.lowSlots.used = 2
        self.fit.stats.lowSlots.total = 2
        restrictionError1 = self.getRestrictionError(holder1, Restriction.lowSlot)
        self.assertIsNone(restrictionError1)
        restrictionError2 = self.getRestrictionError(holder2, Restriction.lowSlot)
    ...
    def testPassGreater(self):
        ...
        self.fit.modules.low.append(holder2)
        self.fit.stats.lowSlots.used = 2
        self.fit.stats.lowSlots.total = 5
        restrictionError1 = self.getRestrictionError(holder1, Restriction.lowSlot)
        self.assertIsNone(restrictionError1)
        restrictionError2 = self.getRestrictionError(holder2, Restriction.lowSlot)
        self.assertIsNone(restrictionError2)

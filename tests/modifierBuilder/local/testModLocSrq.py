...
class TestModLocSrq(EosTestCase):
    ...
    def setUp(self):
        ...
        eTgtSrq = self.dh.expression(expressionId=2, operandId=29, expressionTypeId=3307)
        eTgtAttr = self.dh.expression(expressionId=3, operandId=22, expressionAttributeId=54)
        eOptr = self.dh.expression(expressionId=4, operandId=21, value="PostPercent")
        eSrcAttr = self.dh.expression(expressionId=5, operandId=22, expressionAttributeId=491)
        eTgtItms = self.dh.expression(expressionId=6, operandId=49, arg1Id=eTgtLoc.id, arg2Id=eTgtSrq.id)
        ...
        self.eAddMod = self.dh.expression(expressionId=9, operandId=9, arg1Id=eOptrTgt.id, arg2Id=eSrcAttr.id)
        self.eRmMod = self.dh.expression(expressionId=10, operandId=61, arg1Id=eOptrTgt.id, arg2Id=eSrcAttr.id)

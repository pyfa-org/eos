...
class TestModLoc(ModBuilderTestCase):
    ...
    def setUp(self):
        ...
        self.eAddMod = self.ef.make(7, operandID=8, arg1=eOptrTgt['expressionID'], arg2=eSrcAttr['expressionID'])
        self.eRmMod = self.ef.make(8, operandID=60, arg1=eOptrTgt['expressionID'], arg2=eSrcAttr['expressionID'])

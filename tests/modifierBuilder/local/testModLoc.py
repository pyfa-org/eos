...
class TestModLoc(EosTestCase):
    ...
    def setUp(self):
        ...
        eTgtAttr = self.dh.expression(expressionId=2, operandId=22, expressionAttributeId=1211)
        eOptr = self.dh.expression(expressionId=3, operandId=21, value="PostPercent")
        eSrcAttr = self.dh.expression(expressionId=4, operandId=22, expressionAttributeId=1503)
        ...
        self.eAddMod = self.dh.expression(expressionId=7, operandId=8, arg1Id=eOptrTgt.id, arg2Id=eSrcAttr.id)
        self.eRmMod = self.dh.expression(expressionId=8, operandId=60, arg1Id=eOptrTgt.id, arg2Id=eSrcAttr.id)

...
class TestModOwnSrq(EosTestCase):
    ...
    def setUp(self):
        ...
        eTgtSrq = Expression(dataHandler=dh, expressionId=2, operandId=29, expressionTypeId=3412)
        eTgtAttr = Expression(dataHandler=dh, expressionId=3, operandId=22, expressionAttributeId=1372)
        eOptr = Expression(dataHandler=dh, expressionId=4, operandId=21, value="PostPercent")
        eSrcAttr = Expression(dataHandler=dh, expressionId=5, operandId=22, expressionAttributeId=1156)
        eTgtItms = Expression(dataHandler=dh, expressionId=6, operandId=49, arg1Id=eTgtOwn.id, arg2Id=eTgtSrq.id)
        ...
        self.eAddMod = Expression(dataHandler=dh, expressionId=9, operandId=11, arg1Id=eOptrTgt.id, arg2Id=eSrcAttr.id)
        self.eRmMod = Expression(dataHandler=dh, expressionId=10, operandId=62, arg1Id=eOptrTgt.id, arg2Id=eSrcAttr.id)
        dh.addExpressions((eTgtOwn, eTgtSrq, eTgtAttr, eOptr, eSrcAttr, eTgtItms, eTgtSpec, eOptrTgt, self.eAddMod, self.eRmMod))

...
class TestModItm(EosTestCase):
    ...
    def setUp(self):
        ...
        self.eAddMod = self.ch.expression(expressionId=7, operandId=6, arg1Id=eOptrTgt.id, arg2Id=eSrcAttr.id)
        self.eRmMod = self.ch.expression(expressionId=8, operandId=58, arg1Id=eOptrTgt.id, arg2Id=eSrcAttr.id)

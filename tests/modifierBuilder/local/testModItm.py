...
class TestModItm(EosTestCase):
    ...
    def setUp(self):
        ...
        self.eAddMod = self.dh.expression(expressionId=7, operandId=6, arg1Id=eOptrTgt.id, arg2Id=eSrcAttr.id)
        self.eRmMod = self.dh.expression(expressionId=8, operandId=58, arg1Id=eOptrTgt.id, arg2Id=eSrcAttr.id)

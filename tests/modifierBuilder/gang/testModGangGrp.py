...
class TestModGangGrp(EosTestCase):
    ...
    def setUp(self):
        ...
        eTgtGrp = self.dh.expression(expressionId=1, operandId=26, expressionGroupId=80)
        eTgtAttr = self.dh.expression(expressionId=2, operandId=22, expressionAttributeId=158)
        eOptr = self.dh.expression(expressionId=3, operandId=21, value="PostPercent")
        eSrcAttr = self.dh.expression(expressionId=4, operandId=22, expressionAttributeId=349)
        eTgtSpec = self.dh.expression(expressionId=5, operandId=34, arg1Id=eTgtGrp.id, arg2Id=eTgtAttr.id)
        eOptrTgt = self.dh.expression(expressionId=6, operandId=31, arg1Id=eOptr.id, arg2Id=eTgtSpec.id)
        self.eAddMod = self.dh.expression(expressionId=7, operandId=2, arg1Id=eOptrTgt.id, arg2Id=eSrcAttr.id)
        self.eRmMod = self.dh.expression(expressionId=8, operandId=54, arg1Id=eOptrTgt.id, arg2Id=eSrcAttr.id)

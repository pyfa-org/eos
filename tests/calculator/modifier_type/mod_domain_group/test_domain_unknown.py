...
class TestModDomainGroupDomainUnknown(CalculatorTestCase):

    def test_combination(self):
        tgt_attr = self.ch.attribute(attribute_id=1)
        src_attr = self.ch.attribute(attribute_id=2)
        invalid_modifier = DogmaModifier()
        invalid_modifier.tgt_filter = ModifierTargetFilter.domain_group
        ...
        valid_modifier.tgt_filter = ModifierTargetFilter.domain_group

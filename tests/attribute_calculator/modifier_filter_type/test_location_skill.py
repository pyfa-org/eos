...
from tests.attribute_calculator.environment import IndependentItem, ShipItem, SpaceItem


class TestFilterDomainSkillrq(AttrCalcTestCase):
    """Test domain-skill requirement filter"""

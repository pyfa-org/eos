...
class TestSubsystemSlot(RestrictionTestCase):
    ...
    def test_fail_excess_signle(self):
        ...
        restriction_error = self.get_restriction_error(item, Restriction.subsystem_slot)
    ...
    def test_fail_excess_multiple(self):
        ...
        restriction_error1 = self.get_restriction_error(item1, Restriction.subsystem_slot)
        self.assertIsNotNone(restriction_error1)
        self.assertEqual(restriction_error1.slots_max_allowed, 1)
        self.assertEqual(restriction_error1.slots_used, 2)
        restriction_error2 = self.get_restriction_error(item2, Restriction.subsystem_slot)
    ...
    def test_pass_equal(self):
        ...
        self.add_item(item2)
        self.fit.stats.subsystem_slots.used = 2
        self.fit.stats.subsystem_slots.total = 2
        restriction_error1 = self.get_restriction_error(item1, Restriction.subsystem_slot)

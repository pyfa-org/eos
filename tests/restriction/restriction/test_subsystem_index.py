...
class TestSubsystemIndex(RestrictionTestCase):
    ...
    def test_fail(self):
        ...
        item1 = self.make_item_mock(Subsystem, eve_type)
        item2 = self.make_item_mock(Subsystem, eve_type)
        self.add_item(item1)
        self.add_item(item2)
        restriction_error1 = self.get_restriction_error(item1, Restriction.subsystem_index)
        self.assertIsNotNone(restriction_error1)
        self.assertEqual(restriction_error1.item_slot_index, 120)
        restriction_error2 = self.get_restriction_error(item2, Restriction.subsystem_index)
    ...
    def test_fail_attr_eve_type(self):
        ...
        item1 = self.make_item_mock(Subsystem, eve_type)
        item2 = self.make_item_mock(Subsystem, eve_type)
        item1.attributes = {Attribute.subsystem_slot: 119}
        item2.attributes = {Attribute.subsystem_slot: 121}
        self.add_item(item1)
        self.add_item(item2)
        restriction_error1 = self.get_restriction_error(item1, Restriction.subsystem_index)
        self.assertIsNotNone(restriction_error1)
    ...
    def test_pass(self):
        ...
        # trigger any errors
        eve_type = self.ch.type(type_id=1, attributes={Attribute.subsystem_slot: 120})
        item = self.make_item_mock(Subsystem, eve_type)
        self.add_item(item)
        restriction_error = self.get_restriction_error(item, Restriction.subsystem_index)
    ...
    def test_pass_different(self):
        ...
        item1 = self.make_item_mock(Subsystem, eve_type1)
        item2 = self.make_item_mock(Subsystem, eve_type2)
        self.add_item(item1)
        self.add_item(item2)
        restriction_error1 = self.get_restriction_error(item1, Restriction.subsystem_index)

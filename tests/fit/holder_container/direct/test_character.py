...
class TestDirectHolderCharacter(FitTestCase):
    ...
    def test_detached_none_to_holder_value_failure(self):
        ...
        self.assertIsNone(fit.character)
        self.assertIs(fit_other.character, holder)
        self.assertIs(holder._fit, fit_other)
        # Misc
        fit_other.character = None
        self.assert_fit_buffers_empty(fit)
    ...
    def test_detached_holder_to_holder_value_failure(self):
        ...
        self.assertEqual(len(fit_other.st), 0)
        self.assertIs(fit.character, holder1)
        self.assertIs(fit_other.character, holder2)
        self.assertIs(holder1._fit, fit)

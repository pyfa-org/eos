...
class TestModuleCharge(FitTestCase):
    ...
    def testDetachedModuleNoneToBoundCharge(self):
        ...
        module = Module(1, state=State.active, charge=None)
        moduleOther = Module(3, state=State.active, charge=None)
        chargeOther = Charge(2)
        moduleOther.charge = chargeOther
        fitOther.ordered.append(moduleOther)
        # Action
        self.assertRaises(ValueError, module.__setattr__, 'charge', chargeOther)
        # Checks
        ...
        self.assertIsNone(module.charge)
        self.assertIsNone(module._other)
        self.assertIs(moduleOther.charge, chargeOther)
        self.assertIs(moduleOther._other, chargeOther)
        self.assertIs(chargeOther.container, moduleOther)
        self.assertIs(chargeOther._other, moduleOther)
        self.assertIsNone(module._fit)
        self.assertIs(moduleOther._fit, fitOther)
        self.assertIs(chargeOther._fit, fitOther)
        # Misc
        fitOther.ordered.remove(moduleOther)
    ...
    def testAttachedFitNoneToBoundCharge(self):
        ...
        self.assertIn(module, fit.st)
        self.assertEqual(fit.st[module], {State.offline, State.online, State.active})
        self.assertEqual(len(fitOther.lt), 2)
        self.assertIn(moduleOther, fitOther.lt)
        self.assertEqual(fitOther.lt[moduleOther], {State.offline, State.online, State.active})
        self.assertIn(chargeOther, fitOther.lt)
        self.assertEqual(fitOther.lt[chargeOther], {State.offline})
        self.assertEqual(len(fitOther.rt), 2)
        self.assertIn(moduleOther, fitOther.rt)
        self.assertEqual(fitOther.rt[moduleOther], {State.offline, State.online, State.active})
        self.assertIn(chargeOther, fitOther.rt)
        self.assertEqual(fitOther.rt[chargeOther], {State.offline})
        self.assertEqual(len(fitOther.st), 2)
        self.assertIn(moduleOther, fitOther.st)
        self.assertEqual(fitOther.st[moduleOther], {State.offline, State.online, State.active})
        self.assertIn(chargeOther, fitOther.st)
        self.assertEqual(fitOther.st[chargeOther], {State.offline})
        self.assertIsNone(module.charge)
        self.assertIsNone(module._other)
        self.assertIs(moduleOther.charge, chargeOther)
        self.assertIs(moduleOther._other, chargeOther)

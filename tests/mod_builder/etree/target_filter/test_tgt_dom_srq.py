...
class TestBuilderEtreeModTgtSrq(ModBuilderTestCase):
    ...
    def test_domain_self(self):
        ...
        self.assertEqual(modifier.affectee_filter, ModAffecteeFilter.domain_skillrq)
        self.assertEqual(modifier.affectee_domain, ModDomain.self)
        self.assertEqual(modifier.affectee_filter_extra_arg, 3307)
        self.assertEqual(modifier.affectee_attr_id, 54)
        self.assertEqual(modifier.operator, ModOperator.post_percent)
        self.assertEqual(modifier.affector_attr_id, 491)

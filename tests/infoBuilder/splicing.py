...
class TestSplicing(TestCase):
    ...
    def testBuildSuccess(self):
        ...
        eTgtSrq = Expression(29, typeId=3300)
        eTgtAttr1 = Expression(22, attributeId=54)
        eTgtAttr2 = Expression(22, attributeId=158)
        eTgtAttr3 = Expression(22, attributeId=160)
        eOptr = Expression(21, value="PostPercent")
        eSrcAttr1 = Expression(22, attributeId=351)
        eSrcAttr2 = Expression(22, attributeId=349)
        eSrcAttr3 = Expression(22, attributeId=767)
